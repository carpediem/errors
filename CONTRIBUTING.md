...
We accept bug reports via issues created on [Github](https://github.com/nyamsprod/errors/issues).
...
- **Always try the [master branch](https://github.com/nyamsprod/errors)** - to see if the reported bug has not already been fixed.
...
We accept contributions via Pull Requests on [Github](https://github.com/nyamsprod/errors/pull).
